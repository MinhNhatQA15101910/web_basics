...
app.get("/jokes/:id", (req, res) => {
  ...
  if (typeof foundJoke === "undefined") {
    res.status(404).json({ error: "Joke not found for the chosen id." });
  } else {
...
app.get("/filter", (req, res) => {
  ...
  res.status(200).json(foundJokes);
});
...
app.post("/jokes", (req, res) => {
  ...
  if (typeof jokeText === "undefined" || typeof jokeType === "undefined") {
    res
      .status(400)
      .json({ error: "jokeText and jokeType value must not be empty." });
  } else {
    const newJoke = {
      id: jokes.length + 1,
      jokeText: jokeText,
...
app.put("/jokes/:id", (req, res) => {
  ...
  const replacementJoke = { id: id, jokeText: jokeText, jokeType: jokeType };
